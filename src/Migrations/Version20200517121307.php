 ...
 */
final class Version20200517121307 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recipe ADD author_id INT NOT NULL, CHANGE cook_time cook_time INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recipe DROP author_id, CHANGE cook_time cook_time INT DEFAULT NULL');
    }
}
